    ...
    methods
        ...
        function connectVrep(obj)
            ...
            if (obj.clientID>-1)
                ...
                [~, obj.handles.examSheetHandle] = obj.vrep.simxGetObjectHandle(obj.clientID,'ExamSheet',obj.vrep.simx_opmode_blocking);
                ...
                [~]=obj.vrep.simxGetObjectPosition(obj.clientID,obj.handles.examSheetHandle,-1,obj.vrep.simx_opmode_streaming);
